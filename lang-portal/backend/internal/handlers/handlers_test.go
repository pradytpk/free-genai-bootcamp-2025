...
import (
	"encoding/json"
	"lang-portal/pradytpk/internal/models"
	"lang-portal/pradytpk/internal/service"
	"net/http"
	"net/http/httptest"
	"testing"
...
func setupTestRouter() (*gin.Engine, *Handlers) {
	...
	h := NewHandlers(dashboardService, wordService, groupsService, studyActivitiesService, studySessionsService)
	h.RegisterRoutes(r)
	return r, h
}
