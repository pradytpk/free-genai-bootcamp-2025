...
- words - stored vocabulary words
  ...
  | japanese | string | Japanese text |
  | romaji | string | Romanized version of the Japanese text|
  | english | string | English translation |
  | parts | json | Additional metadata or parts in JSON |
...
- groups - thematic groups of words
  ...
  | ------ | ------- | ------------------------------ |
  | id     | integer | Primary key, auto-incrementing |
  | name   | string  | Name of the thematic group     |
...
- study_sessions - records of study sessions grouping word_review_items
  ...
  | id | integer | Primary key, auto-incrementing |
  | group_id | integer | Foreign key referencing `groups.id` |
  | created_at | datetime | Timestamp of when the study session started |
...
- study_activities - a specific study activity, linking a study session to group
  ...
  | group_id | integer | Foreign key referencing `groups.id` |
  | created_at | datetime | Timestamp of when the study activity was created |
...
- word_review_items - a record of word practice, determining if the word was correct or not
  ...
  | word_id | integer | Foreign key referencing `words.id` |
  | study_session_id | integer | Foreign key referencing `study_sessions.id` |
  | correct | boolean | Indicates if the word was answered correctly |
  | created_at | datetime | Timestamp of when the word was reviewed |
...
```json
{
  "id": 123,
  "group_id": 456,
  "created_at": "2025-02-18T20:35:10-05:00",
  ...
  "items": [
    {
      ...
      "group_name": "Basic Greetings",
      "start_time": "2025-02-18T20:35:10-05:00",
...
```json
{
  "success": true,
  "word_id": 1,
  "study_session_id": 001,
  "correct": true,
  "created_at": "2025-02-12T17:33:07-05:00"
}
```
